       ...
       @endif   
          ...
          <div class="box">
            <div class="box-header">
              ...
              <div class="pull-right"> <a href="{{ url('admin/template/add')}}" class="btn btn-primary"><i class="fa fa-plus"></i> Add</a></div>
            </div>
            <!-- /.box-header -->
            ...
            <div class="box-body">
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tr>
                  ...
                  <td>
                      <a href="{{url('/admin/template/edit') }}/{{ $val->id }}"><i class="fa fa-edit" title="Edit" ></i> </a>
                      <a href="{{url('/admin/template/send') }}/{{ $val->id }}"><i class="fa fa-reply" title="Send" ></i> </a>
                      ...
                      <div class="modal-dialog" role="document">
                        <div class="modal-content">
                          ...
                          <div class="modal-footer">
                            ...
                            <form action = "{{url('/admin/template/delete')}}" method="post">
                                  {{ csrf_field() }}
